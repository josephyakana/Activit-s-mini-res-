...
function MenuDrawer({
  ...
  const notifCount = nonRegle.length + nonConforme.length;
        ...
        <div style={{ display: "grid", gap: 10 }}>
          ...
          {declarations.map((c) => (
            <div key={c.id} style={cardStyle}>
              ...
              <div style={{ fontSize: 11, color: "#A99B7F", marginTop: 4 }}>
...
function CarteRectoVerso({ artisan, commune }) {
  ...
  return (
    <div className="print-area" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          {/* ============ RECTO ============ */}
          <div className="carte-page carte-recto" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          {/* ============ VERSO ============ */}
          <div className="carte-page carte-verso" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
    ...
    <div>
      <style>{`
        @media print {
          ...
          .carte-page { page-break-after: always; padding: 0 !important; margin: 0 !important; }
          .carte-page:last-child { page-break-after: auto; }
          .carte-face { box-shadow: none !important; border: none !important; margin: 0 auto !important; }
          @page { size: 89.99mm 56.61mm; margin: 0; }
        }
      `}</style>
