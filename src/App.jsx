      ...
      >
        ...
        {agent && (
          <button type="button" onClick={onGoDashboard} style={menuRowStyle}>
            ...
            <span style={{ flex: 1, fontSize: 14, color: "var(--text)" }}>
              {t("tableauDeBord")} · {siteSection === "industriel" ? t("secteurIndustrielLabel") : t("sectionMiniereLabel")}
            </span>
            <ChevronRight size={16} color="var(--text-faint)" />
          </button>
        )}
        ...
        >
          <div style={{ display: "grid", gap: 6 }}>
            <button
              type="button"
              onClick={() => { setSiteSection("miniere"); setSection(null); onClose(); onGoDashboard(); }}
              style={{
            ...
            <button
              type="button"
              onClick={() => { setSiteSection("industriel"); setSection(null); onClose(); onGoDashboard(); }}
              style={{
                display: "flex", alignItems: "center", gap: 10, textAlign: "left", padding: "8px 12px", borderRadius: 4,
...
export default function App() {
  ...
  const [siteSection, setSiteSectionState] = useState(() => {
    try {
      return localStorage.getItem("siteSection") === "industriel" ? "industriel" : "miniere";
    } catch {
      return "miniere";
    }
  }); // "miniere" | "industriel"

  const setSiteSection = (nextSection) => {
    const value = nextSection === "industriel" ? "industriel" : "miniere";
    setSiteSectionState(value);
    try { localStorage.setItem("siteSection", value); } catch {}
  };
